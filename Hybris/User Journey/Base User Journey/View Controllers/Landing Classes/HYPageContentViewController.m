...
#import "HYPageContentViewController.h"

@interface HYPageContentViewController ()
...
@implementation HYPageContentViewController
...
- (void)viewWillAppear:(BOOL)animated {
    ...
    NSLog(@"childViewControllers %i",[self.childViewControllers count]);
